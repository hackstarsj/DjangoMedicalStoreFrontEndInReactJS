...
class MedicineViewComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  async LoadMedicine() {
    var apihandler = new APIHandler();
    var medicinedata = await apihandler.fetchMedicineAll();
    var comapnydata = await apihandler.fetchCompanyOnly();
    // console.log(comapnydata);
    //console.log(medicinedata);
    this.setState({ medicineList: medicinedata.data.data });
  ...
  viewMedicine = (index) => {
    console.log(this.state.medicineList[index]);
    this.setState({ name: this.state.medicineList[index].name });
    this.setState({ medical_typ: this.state.medicineList[index].medical_typ });
    this.setState({ buy_price: this.state.medicineList[index].buy_price });
    this.setState({ sell_price: this.state.medicineList[index].sell_price });
    this.setState({ c_gst: this.state.medicineList[index].c_gst });
    this.setState({ s_gst: this.state.medicineList[index].s_gst });
    this.setState({ batch_no: this.state.medicineList[index].batch_no });
    this.setState({ shelf_no: this.state.medicineList[index].shelf_no });
    this.setState({ expire_date: this.state.medicineList[index].expire_date });
    this.setState({ mfg_date: this.state.medicineList[index].mfg_date });
    this.setState({ description1: this.state.medicineList[index].description });
    // this.setState({ company_id: this.state.medicineList[index].description });
    this.setState({
      medicinedetails: this.state.medicineList[index].medicine_details,
    });
    this.setState({
      in_stock_total: this.state.medicineList[index].in_stock_total,
    });
    this.setState({
      qty_in_strip: this.state.medicineList[index].qty_in_strip,
    });
  };
                        ...
                        <tr key={medicine.id}>
                          ...
                          <td>
                            <button
                              ...
                              onClick={() => this.viewMedicine(index)}
                            >
                              View
                            </button>
                          </td>
                      ...
                      >
                        {this.state.companylist.map((item) => (
                          <option
                            key={item.id}
                            value={item.id}
                            selected={item.id == this.state.company_id}
                          >
                            {item.name}
                          </option>
                        ))}
...
export default MedicineViewComponent;
